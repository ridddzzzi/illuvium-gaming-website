    ...
    return (
      ...
      <main className='relative w-full h-screen overflow-hidden flex justify-center mb-[10%]'>
        ...
        <div className='absolute bottom-[15%] flex flex-col items-center gap-5 '>
            ...
            <button className="bg-gradient-to-r from-purple-500 to-indigo-600 cursor-pointer h-10 px-16 rounded-lg font-medium text-nowrap hover:opacity-70 transition-all duration-300">
                        PLAY NOW
                    </button>
            ...
            <p className='max-w-[80%] text-center text-[#babaff]'>
                Notice: Illuvium Games Are In Beta.Participation Involves Risk.Read The Full Disclaimer Here.
            </p>
